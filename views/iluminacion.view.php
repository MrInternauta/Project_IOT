			...
			<div class="content">
				<div class="container-fluid">
					...
					<div class="row">
                        ...
                        <strong>Control automatico de luces</strong>
                        ...
                        <form class="form-signin" method="POST" action="<?php echo  htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                ...
                                if ($estado0[0]==8) {
                                  ...
                                  echo "<input  class='btn btn-lg btn-danger btn-block' type='submit' value='Desactivar' name='estado0'> <br> <a href='alarmas.php#temp'>Configurar </a>control automatico";
                      ...
                      <br>
                                ...
                                Luces 2  <br>
                                       ...
                                       if ($estado2[0]==3) {
                                         ...
                                         echo "<input  class='btn btn-lg btn-danger btn-block' type='submit' value='Apagar' name='estado2'>";
                                       ...
                                       if ($estado2[0]=='a') {
                                         ...
                                         echo "<input  class='btn btn-lg btn-primary btn-block' type='submit' value='Encender' name='estado2'>";
                        ...
                        <?php else: ?>
                          <p>Debe desactivar el control automatico de luces para poder controlar manualmente la iluminacion.
                      </p>
                        <?php endif; ?>
